...
def get_model():
    ...
    model = keras.applications.inception_v3.InceptionV3(include_top=False, weights='imagenet', input_tensor=None, input_shape=(CROP_SIZE, CROP_SIZE,3), pooling='avg') 
...
filepath = '../../rakuten/model-inception-v3-retrain-{epoch:02d}-{val_loss:.2f}-{val_acc:.4f}.hdf5'
...
model.save('../../rakuten/rakuten_inception_v3_retrain_model.h5')					  
